...
## 2026-08-14 通宵执行记录（用户授权：先图文，再平台适配，视频后置）

> 用户 2026-08-14 离开前明确：先好好做图文；同一主题按平台生成不同内容；流程分受控和全自动两条；视频之后再做；结合已确认产品定义连夜能做的做完。真发、小红书真发、无人值守发布仍禁止。

- [x] **NIGHT-01｜首页一次生成图文文章**  
  ✅ 完成于 2026-08-14，commit 6769f36，备注：点「生成文章」会起草主稿，不再打开空白编辑器。

- [x] **NIGHT-02｜就地改段，而不是右侧建议仓库**  
...
- [x] **WX-LOOP｜微信闭环先收口**  
  ✅ 完成于 2026-08-15，备注：微信页只留预览、选号、送草稿。头条/小红书下一轮再做，不在这页预告。

- [x] **VIDEO-SLICE｜文章做成可下载短片**  
  ✅ 完成于 2026-08-15，commit 6312a46，备注：文章页「视频」tab 出 18 秒口播短片并可下载。`prj_884eda69` 已用正文三句口播 + 三张配图镜头拼成 `video/preview.mp4`。不接视频号/抖音/B 站发布。

- [x] **UX-PACK｜一个主题三份成品**  
  ✅ 完成于 2026-08-15，备注：写作/灵感合并到首页；作品页改成文章/微信/视频三份成品，去掉并列的「更多」。

- [x] **VIDEO-VOICE｜口播配音和字幕**  
  ✅ 完成于 2026-08-15，备注：按口播流程重做：先写能念的稿，edge-tts 配音，镜头叠字幕，竖版 9:16。上一版没声音是因为没加配音。

- [ ] **NEXT-TOUTIAO｜头条适配**  
  未开工。等用户确认微信闭环够用后再做。头条是长文，但不能只做标题微调。

- [ ] **NEXT-XHS｜小红书适配**  
  未开工。小红书按图文卡片做，不从这篇公众号长文改几个字交差。
