...
- [ ] 用户已批准“中转站 AI 写稿 + GPT Image 2 配图 + Markdown 编辑/预览 + 公众号草稿箱”。任务拆分与验收要求见 [BYOK_FIRST_USE_TASKS.md](./BYOK_FIRST_USE_TASKS.md)。BYOK-1 已完成（专项 89 passed）；下一任务 BYOK-2。尚未进行真实生成或公众号发送。公众号凭据由用户后续提供。此条不是 R0 作者签字或真实发送验收完成记录。
