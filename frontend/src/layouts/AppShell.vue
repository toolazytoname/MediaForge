...
const primaryItems: ReadonlyArray<NavItem> = [
  ...
  { path: '/projects', label: '作品', icon: FolderOpenOutlined },
  { path: '/accounts', label: '账号', icon: FileTextOutlined },
]
...
.sidebar-actions { display: flex; flex-direction: column; gap: 8px; padding: 0 12px 12px; }
