...
export interface ApprovalEvent { action: 'rechecked' | 'approved' | 'revoked'; check_id: string | null; note: string | null; actor: string; at: string }
...
export interface DeliveryAttemptResult {
  id: string
  mode: 'preview' | 'export' | 'draft' | 'direct'
