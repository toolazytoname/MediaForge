...
export interface ProjectExportResult { project_id: string; file_name: string; path: string; url: string; kind?: string }
export const useApprovalsStore = defineStore('approvals', () => {
  ...
  async function exportMarkdown(projectId: string) { return (await apiPost<ProjectExportResult>(`/projects/${projectId}/export/markdown`, {})).data }
  return { status, loading, error, load, recheck, decide, exportPackage, exportMarkdown }
})
